...
// 查询所有用户信息
func SelectAllUsers() (*[]model.Users, error) {
	var usersList = make([]model.Users, 0, 20) //传一个切片
...
// 添加用户信息
func Adduser(newUser *model.Users) (err error) {
...
// 查询多条数据（模糊查询）
func SelectLikeUsers(value *string) (*[]model.Users, error) {
	...
	var usersList = make([]model.Users, 0, 20)
	var user model.Users //传一个切片
